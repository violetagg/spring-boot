 ...
 * directly.
 * This is based on {@link org.springframework.boot.web.embedded.netty.NettyWebServer}
 *
...
public class NettyWebServer implements WebServer {
	...
	public NettyWebServer(HttpServer httpServer, ReactorNetty5HttpHandlerAdapter handlerAdapter, Duration lifecycleTimeout,
	                      Shutdown shutdown) {
		Assert.notNull(httpServer, "HttpServer must not be null");
		Assert.notNull(handlerAdapter, "HandlerAdapter must not be null");
		this.lifecycleTimeout = lifecycleTimeout;
		this.handler = handlerAdapter;
		this.httpServer = httpServer.channelGroup(new DefaultChannelGroup(new SingleThreadEventExecutor()));

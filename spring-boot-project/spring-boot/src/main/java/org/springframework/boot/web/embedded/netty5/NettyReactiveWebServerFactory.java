...
package org.springframework.boot.web.embedded.netty5;
...
import org.springframework.http.server.reactive.ReactorNetty5HttpHandlerAdapter;
 ...
 * This class is based on {@link org.springframework.boot.web.embedded.netty.NettyReactiveWebServerFactory}
 *
...
public class NettyReactiveWebServerFactory extends AbstractReactiveWebServerFactory {
	...
	private ReactorNetty5ResourceFactory resourceFactory;
	...
	public WebServer getWebServer(HttpHandler httpHandler) {
		...
		ReactorNetty5HttpHandlerAdapter handlerAdapter = new ReactorNetty5HttpHandlerAdapter(httpHandler);
	...
	NettyWebServer createNettyWebServer(HttpServer httpServer, ReactorNetty5HttpHandlerAdapter handlerAdapter,
	...
	/**
	 * Set the {@link ReactorNetty5ResourceFactory} to get the shared resources from.
	 * @param resourceFactory the server resources
	 * @since 2.1.0
	 */
	public void setResourceFactory(ReactorNetty5ResourceFactory resourceFactory) {
	...
	private HttpServer createHttpServer() {
		...
		if (this.resourceFactory != null) {
			...
			Assert.notNull(resources, "No LoopResources: is ReactorNetty5ResourceFactory not initialized yet?");

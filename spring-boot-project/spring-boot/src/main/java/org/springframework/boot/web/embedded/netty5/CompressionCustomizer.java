...
/**
 * Configure the HTTP compression on a Reactor Netty (Netty 5) request/response handler.
 * This class is based on {@link org.springframework.boot.web.embedded.netty.CompressionCustomizer}
 *
